...
function zeigeWerkInfo(werkId) {
	...
	let description6;
	if (document.getElementById('ueberschrift').innerHTML === "Stahl mit Seele") {
		description6 = "Ich lade Sie herzlich ein, mich auf der diesjährigen Kunstmesse Burg Stettenfels direkt auf meine Gedanken zum Werk anzusprechen. Gleichzeitig möchte ich Sie ermutigen, sich selbst einen Moment Zeit zu nehmen, das Werk auf sich wirken zu lassen und Ihre ganz persönliche Interpretation entstehen zu lassen.";
	}
	else {
		description6 = "I warmly invite you to approach me at this year's Burg Stettenfels art fair to discuss my thoughts on the work. At the same time, I encourage you to take a moment for yourself, let the artwork speak to you, and develop your own personal interpretation.";
	}
